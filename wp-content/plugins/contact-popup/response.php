...
<div class="clear"></div>
	...
	<div id="con_of-nav">
		<ul>
			<li> <a  class="pn-view-a" href="#pn_generalsettings" title="Contact Form">Contact From</a></li>
		...
		<h2>Form Builder</h2>
			<div class="con_section section-text">
<h3 class="con_heading"> Create form according to requirement</h3>
		...
		<h2>Embed Code</h2>
			<div class="con_section section-text">
			<h3 class="con_heading">Paste here embed code generated by form builder</h3>
			<div class="option">
	...
	<div class="con_group" id="pn_template">
		<h2>Steps to use Popup Contact Plugin</h2>
			...
			<h3></h3>
             ...
             <ol class="step_ol">
             <li class="step_li">We have provided the dummy contact form. Now you can build your form acording to your requirement by using "Form Builder" menu.</li></br>
